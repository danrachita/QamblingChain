...
#   c) node1 mines 32 blocks, so now node 0 has 500000QCN, node 1 has 4250QCN, node2 has none.
#   d) node0 sends 601 QCN to node2, in two transactions (301 QCN, then 300 QCN).
