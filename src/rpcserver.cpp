...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop QamblingChain server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "QamblingChain server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* QamblingChain features */
        {"qamblingchain", "masternode", &masternode, true, true, false},
        {"qamblingchain", "listmasternodes", &listmasternodes, true, true, false},
        {"qamblingchain", "getmasternodecount", &getmasternodecount, true, true, false},
        {"qamblingchain", "masternodeconnect", &masternodeconnect, true, true, false},
        {"qamblingchain", "masternodecurrent", &masternodecurrent, true, true, false},
        {"qamblingchain", "masternodedebug", &masternodedebug, true, true, false},
        {"qamblingchain", "startmasternode", &startmasternode, true, true, false},
        {"qamblingchain", "createmasternodekey", &createmasternodekey, true, true, false},
        {"qamblingchain", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"qamblingchain", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"qamblingchain", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"qamblingchain", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"qamblingchain", "getmasternodescores", &getmasternodescores, true, true, false},
        {"qamblingchain", "mnbudget", &mnbudget, true, true, false},
        {"qamblingchain", "preparebudget", &preparebudget, true, true, false},
        {"qamblingchain", "submitbudget", &submitbudget, true, true, false},
        {"qamblingchain", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"qamblingchain", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"qamblingchain", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"qamblingchain", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"qamblingchain", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"qamblingchain", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"qamblingchain", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"qamblingchain", "checkbudgets", &checkbudgets, true, true, false},
        {"qamblingchain", "mnsync", &mnsync, true, true, false},
        {"qamblingchain", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> qamblingchain-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8052/\n";
}
