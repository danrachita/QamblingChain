...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("QamblingChain Core qamblingchain-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  qamblingchain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded qamblingchain transaction") + "\n" +
                               "  qamblingchain-tx [options] -create [commands]   " + _("Create hex-encoded qamblingchain transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded qamblingchain transaction
