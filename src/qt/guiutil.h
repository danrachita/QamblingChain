...
/** Utility functions used by the QamblingChain Qt UI.
 */
namespace GUIUtil
{
...
// Render QCN addresses in monospace font
...
// Parse "qamblingchain:" URI into recipient object, return true on successful parsing
