...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("QamblingChain Core"),
     ...
     * override -datadir in the qamblingchain.conf file in the default data directory
     * (to be consistent with qamblingchaind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
