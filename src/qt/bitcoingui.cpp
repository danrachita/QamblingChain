                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("QamblingChain Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a QCN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and qamblingchain: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About QamblingChain Core"), this);
    aboutAction->setStatusTip(tr("Show information about QamblingChain Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for QamblingChain"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your QCN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified QCN addresses"));
    ...
    openAction->setStatusTip(tr("Open a qamblingchain: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the QamblingChain Core help message to get a list with possible QamblingChain command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("QamblingChain Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to QamblingChain network", "", count));
}
...
{
    QString strTitle = tr("QamblingChain Core"); // default title
