Contributing to QamblingChain Core
==================================

The QamblingChain Core project operates an open contributor model where anyone is
...
The following applies to code changes to the QamblingChain Core project, and is not to be
confused with overall QamblingChain Network Protocol consensus changes.

Whether a pull request is merged into QamblingChain Core rests with the project merge
...
Patches that change QamblingChain consensus rules are considerably more involved than
...
Where a patch set proposes to change the QamblingChain consensus, it must have been
...
The project leader is the release manager for each QamblingChain Core release.
