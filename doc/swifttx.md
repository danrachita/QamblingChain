...
This mechanism has been integrated into Bitcore-Node-QamblingChain which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/qamblingchain/insight-api-qamblingchain#web-socket-api](https://github.com/qamblingchain/insight-api-qamblingchain#web-socket-api)
* API: [https://github.com/qamblingchain/insight-api-qamblingchain#swifttx-transactions](https://github.com/qamblingchain/insight-api-qamblingchain#swifttx-transactions)
...
By default, the QamblingChain Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the QamblingChain Core daemon:
