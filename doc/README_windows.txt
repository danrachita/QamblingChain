...
Intro
-----
QamblingChain (QCN) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. QamblingChain utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run qamblingchain-qt.exe.

QamblingChain Core is the original QamblingChain client and it builds the backbone of the network.
However, it downloads and stores the entire history of QamblingChain transactions;
