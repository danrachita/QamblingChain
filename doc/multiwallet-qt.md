...
In order to support loading of multiple wallets in qamblingchain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is qamblingchain.cpp.
...
Changes to qamblingchain.cpp
----------------------
qamblingchain.cpp is the entry point into qamblingchain-qt, and as such, will require some minor modifications to provide hooks for
